...
mat = loadmat('F16traindata_CMabV_2020.mat')
    ...
    if doIEKF:
        ...
        while err > epsilon:  # and itts < maxIterations:
            ...
            if (k == 0 and itts == 0):
                ...
                if (rankHF < n):
                    print('The current state is not observable; rank of Observability Matrix is %d, should be %d',
                          rankHF, n);
