...
time_data = np.genfromtxt('time_sequence.csv', delimiter=',')
...
#
# plt.figure()
# for i in [5, 10, 25, 50]:  # with the random init we start with a higher error because of the higher number of neurons
